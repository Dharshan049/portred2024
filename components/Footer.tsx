  ...
  return (
    <footer className="w-full pb-10 mb-[100px] md:mb-5 relative" id="contact">
      ...
      <h1 className="heading lg:max-w-[45vw] text-center text-gray-900 dark:text-gray-100">
        I am a student, ready to connect and explore opportunities in <span className="text-purple">AI, Computer Vision, and Game Development</span>!
      </h1>
      <p className="text-gray-700 dark:text-gray-300 md:mt-10 my-5 text-center">
        Contact me today and let's discuss how I can contribute to exciting projects and gain valuable experience.
      </p>

        <a href="mailto:redharshan1@gmail.com">
          <MagicButton
